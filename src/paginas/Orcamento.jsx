...
export default function Orcamento({ setPaginaAtual }) {
  ...
  const gerarJPG = () => {
    html2canvas(conteudoRef.current, {
      ...
      link.href = imgData;
      link.download = "orcamento_pretim_do_brilho.jpg";
      link.click();
    });
  };
  ...
  return (
    <>
      {/* CONTEÚDO PARA IMAGEM */}
      <div className="financeiro-container" ref={conteudoRef}>
        <img className="topoFinanceiro" src="img/topo-financeiro.jpg" alt="" />
        ...
        {/* Forma de pagamento */}
        <div className="section">
          <div className="section-title">Forma de pagamento e prazo</div>
          <div className="input-row">
            <div className="input-group">
              <label htmlFor="Pix">Pix</label>
              <input type="text" id="pix" placeholder="Inserir valor" />
            </div>
            <div className="input-group">
              <label htmlFor="cartao">Cartão de crédito</label>
              <input type="text" id="cartao" placeholder="Quantas parcelas?" />
            </div>
            <div className="input-group">
              <label htmlFor="cartao">Prazo</label>
              <input type="text" id="prazo" placeholder="Prazo de serviço" />
            </div>
          </div>
        </div>
